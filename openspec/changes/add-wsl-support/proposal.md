...
- **MODIFIED** *Click to focus live terminal pane* — for WSL-origin entries, the click falls through to the resume path (live focus across the WSL/Windows boundary is not feasible).
